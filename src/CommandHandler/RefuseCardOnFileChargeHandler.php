...
/**
 * Fails a request that named the card-on-file charge's action without coming through the charger.
 * Nothing is read, locked or sent: the request fails and says why.
 *
 * @internal
 */
final class RefuseCardOnFileChargeHandler
{
    public const NOT_HERE = 'jpm_martin_sylius_nmi.payment.card_on_file_charge_not_available_here';
    ...
    public function __invoke(RefuseCardOnFileCharge $command): void
    {
