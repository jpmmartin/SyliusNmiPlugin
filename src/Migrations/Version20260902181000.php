...
final class Version20260902181000 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE jpm_martin_sylius_nmi_transaction (id INT AUTO_INCREMENT NOT NULL, payment_id INT NOT NULL, transaction_id VARCHAR(64) NOT NULL, type VARCHAR(16) NOT NULL, amount INT NOT NULL, currency_code VARCHAR(3) NOT NULL, auth_code VARCHAR(32) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', settled_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_5C14A2864C3A3BB (payment_id), INDEX idx_jpm_martin_sylius_nmi_transaction_transaction_id (transaction_id), UNIQUE INDEX uniq_jpm_martin_sylius_nmi_transaction_id_type (transaction_id, type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
